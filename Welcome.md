...
Welcome to VS Code! This is your new home for coding. Before we dive into the heavy lifting, let's make this place feel like *yours*.

## 1. Dress It Up (Themes) 🖌️
Coding is more fun when your editor looks good. VS Code lets you change the entire color scheme to match your vibe.
...
*   **The "Source Control" Tab:**
    *   Look for the icon that looks like a branch (Y-shape) on the left sidebar:
    ...
    ![Source Control Icon](images/source_control.png)
...
VS Code is great out of the box, but Extensions give it superpowers.

**We need one specific superpower right now: Jupyter.**
Since we are going to be doing some data science and biotechnology work, we need to be able to run "Notebooks" right here in VS Code.
